...
.sheet-options-grid::-webkit-scrollbar {
  width: 10px;
}

.sheet-options-grid::-webkit-scrollbar-track {
  border-radius: 999px;
  background: linear-gradient(
    180deg,
...
.sheet-options-grid::-webkit-scrollbar-thumb {
...
.sheet-options-grid::-webkit-scrollbar-thumb:hover {
  background: linear-gradient(
    180deg,
