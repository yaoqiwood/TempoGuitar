...
.signature-options-grid::-webkit-scrollbar {
  width: 10px;
}

.signature-options-grid::-webkit-scrollbar-track {
  border-radius: 999px;
  background: linear-gradient(
    180deg,
...
.signature-options-grid::-webkit-scrollbar-thumb {
...
.signature-options-grid::-webkit-scrollbar-thumb:hover {
  background: linear-gradient(
    180deg,
